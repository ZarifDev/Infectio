...
public class EnemySpawner : MonoBehaviour
{
   ...
   [SerializeField]  int[] enemiesSpawnCost;

        public static List<GameObject> enemiesActiveInScene = new List<GameObject>();
       [SerializeField] List<GameObject> ActiveInSceneTest;
    void Start()
    {
    ...
    void Update()
    {
      ...
      if(enemiesActiveInScene.Count ==0|| Input.GetKeyDown(KeyCode.E))
      {
  print("aee");
        SpawnEnemies();        
      }
      ActiveInSceneTest = enemiesActiveInScene;
    }
    void SpawnEnemies()
    {int spawnPointId = 0;
